...
#
# GUILD_IDS = [847268531648462860, 998379655906213918, 937139620368511026]
#
#
...
#         await wavelink.NodePool.create_node(bot=self.bot, host='jonnythedev.com', port=2333, password='QEpvbm55MDUxMA==',
#                                             https=False, spotify_client=spotify.SpotifyClient(client_id="72b562bb80bf4e44a2ffdbbdee9a105e", client_secret="e5c08ebdfad04167b42ae7a1789c7273"))
#
